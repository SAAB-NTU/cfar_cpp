...
#include "cfar_cpp/msg/detail/cfar_info__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = cfar_cpp::msg::CfarInfo;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const cfar_cpp::msg::CfarInfo *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<cfar_cpp::msg::CfarInfo *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _CfarInfo__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const cfar_cpp::msg::CfarInfo *>(
...
static size_t _CfarInfo__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_CfarInfo(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _CfarInfo__callbacks = {
  "cfar_cpp::msg",
  "CfarInfo",
...
static rosidl_message_type_support_t _CfarInfo__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_CfarInfo__callbacks,
...
template<>
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_EXPORT_cfar_cpp
const rosidl_message_type_support_t *
get_message_type_support_handle<cfar_cpp::msg::CfarInfo>()
{
  return &cfar_cpp::msg::typesupport_fastrtps_cpp::_CfarInfo__handle;
}
